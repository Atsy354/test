        ...
        <aside class="w-64 bg-white shadow-lg">
            <div class="p-6">
                ...
                <ul class="space-y-2">
                    ...
                    class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors {{ request()->routeIs('admin.lokasis.*') ? 'bg-blue-50 text-blue-600' : '' }}">
